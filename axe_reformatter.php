...
// + The "url" attribute within each "results" object is used to create an object within a "pages" array. The object will include the "pageName" attribute, which is the "url" in the input data, and a unique id.
